...
const data = [
    { key: 'Group 1', values: [ { x: 110, y: 110, r: randomNumber() }, { x: 200, y: randomNumber(), r: randomNumber() }, { x: randomNumber(), y: randomNumber(), r: randomNumber() }, { x: randomNumber(), y: randomNumber(), r: randomNumber() } ] },
